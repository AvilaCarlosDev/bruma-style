...
Bruma-style contiene configuración de escritorio y scripts auxiliares locales. No
...
Bruma-style contains desktop configuration and local helper scripts. It does not
